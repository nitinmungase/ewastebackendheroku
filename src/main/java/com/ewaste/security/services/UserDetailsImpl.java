...
public class UserDetailsImpl implements UserDetails {
	...
	public UserDetailsImpl(Long id, String fullname, String username, String email, String password, String mobile,
	...
	public static UserDetailsImpl build(User user) {
		...
		return new UserDetailsImpl(user.getId(), user.getFullname(), user.getUsername(), user.getEmail(),
				user.getPassword(), user.getMobile(), user.getAddress(), authorities);
	}
